...
-- Assignment 2, Task 2 (Updated with full dataset for subsequent assignments)
--
...
CREATE TABLE IF NOT EXISTS public.inventory (
  ...
  classification_id INTEGER NOT NULL,
  CONSTRAINT inventory_pkey PRIMARY KEY (inv_id)
>>>>>>> 9a23763c248bdb24fe8816a1ba20dfe67787d74c
);
...
-- Update image paths to include /vehicles/ subfolder
...
-- Update GM Hummer description to "a huge interior"
